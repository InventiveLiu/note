...
今天在[Alibaba F2E 的公众号](https://mp.weixin.qq.com/s/QCzXQ5QfX5rhX3GTheYycw)上看到，`plugin-transform-runtime`不要配`corejs`带上补丁，不管是项目还是组件，即不要用第三种方式，这是为什么？文章没有给出答案，让读者自己思考，上面总结的第三种方式的缺点是会造成包体积变大，但我觉得这不是原因，先关注一下这个问题
